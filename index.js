...
AWS.config.update({
  accessKeyId: 'SESUAIKAN', // Ganti dengan Access Key ID Anda
  secretAccessKey: 'SESUAIKAN', // Ganti dengan Secret Access Key Anda
...
app.post('/upload', upload.single('file'), (req, res) => {
  ...
  const params = {
    Bucket: 'bucketfadlan', // Ganti dengan nama bucket Anda
...
app.get('/files', async (req, res) => {
  try {
    const params = { Bucket: 'bucketfadlan' }; // Ganti dengan nama bucket Anda
